...
function App() {
  ...
  <div className="app-container">
    <div className="container-fluid text-center text-white" style={{ backgroundColor: '#80a981', padding: '3px 0'}}>
      {/* Title Section */}
      <h1 className="text-center">Hatchmaps</h1>
      {/* Links Section */}
      <div className="row justify-content-center" style={{ padding: '3px 0'}}>
        <div className="col">
