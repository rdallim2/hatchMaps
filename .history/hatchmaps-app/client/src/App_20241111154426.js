  ...
  <div className="app-container">
    <header className="header">
      <div className="flex-center-header">
        <h1>HatchMaps</h1>
        <div class="col">
          <ul style={{ display: 'flex', justifyContent: 'space-evenly', padding: 0, margin: 0 }}>
            <li style={{ listStyle: 'none' }}><a href="#github">Github</a></li>
            <li style={{ listStyle: 'none' }}><a href="#contact">Contact</a></li>
            <li style={{ listStyle: 'none' }}><a href="#species-charts">Species Charts</a></li>
          </ul>
        </div>
      </div>
    </header>
